<template>
    <el-row>
        <el-form :model="form" label-position="right" :label-width="formLabelWidth" :rules="rules" ref="form">
            <el-form-item label="角色名称" prop="alias_name">
                <el-input v-model="form.alias_name" class="w-300" size="medium"
                          autocomplete="off" placeholder="请输入角色名称"></el-input>
            </el-form-item>
            <el-form-item label="角色标识" prop="name">
                <el-input v-model="form.name" class="w-300" size="medium"
                          autocomplete="off" placeholder="请输入角色标识"></el-input>
            </el-form-item>
        ...
        initForm() {
            ...
            if (this.dialogTitle === 'editTitle') {
                this.form = {
                    ...
                    alias_name: this.rowData.alias_name,
                }
                this.$nextTick(() => {
                    // 渲染已经存在的权限
